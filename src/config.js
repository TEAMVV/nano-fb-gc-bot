...
exports.trigger = "nano";

// Bot owner information
exports.owner = {
    "names": {
        "short": "BotolBaba",
        "long": "Mehedi Hasan Ariyan"
    },
    "id": "100009601655445" // ID of bot owner (for secure commands, reports, and alerts)
};

// Bot information
exports.bot = {
    "names": {
        "short": "GroupBaba", // Will be used as 'nickname' in chat (remove if same as account name)
        "long": "GroupBaba Bot" // Name displayed in profile on bot's Facebook account
    },
    "id": "100066807444736" // Bot's ID (for security purposes in commands)
};
